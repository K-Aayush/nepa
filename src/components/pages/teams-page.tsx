...
const teamMembers = [
  {
    ...
    role: "Team Lead",
    image: "/robot.svg",
    description: "Leads the team with a passion for robotics, AI, and innovative solutions.",
    hierarchy: 1,
  },
  {
    name: "Priya Sharma",
    role: "IoT Specialist",
    image: "/window.svg",
    description: "Expert in IoT systems, device integration, and smart city solutions.",
    hierarchy: 2,
  },
  {
    name: "Rahul Verma",
    role: "AI Engineer",
    image: "/globe.svg",
    description: "Focuses on machine learning, data analysis, and intelligent automation.",
    hierarchy: 2,
  },
  {
    name: "Sneha Patel",
    role: "UI/UX Designer",
    image: "/next.svg",
    description: "Designs user-friendly interfaces and ensures a seamless user experience.",
    hierarchy: 2,
  },
  {
    name: "Vikram Singh",
    ...
    image: "/vercel.svg",
    description: "Builds robust web applications and manages backend infrastructure.",
    hierarchy: 2,
  },
  {
    name: "Anjali Mehra",
    ...
    image: "/file.svg",
    description: "Crafts engaging content and manages communication strategies.",
    hierarchy: 2,
  },
];
...
const TeamsPage = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-white py-20 px-2 md:px-8">
      <div className="max-w-7xl w-full mx-auto text-center px-2 md:px-8">
        ...
        {/* Team Lead */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-blue-700 mb-8 uppercase tracking-widest">Team Lead</h3>
        ...
        {/* Other Members */}
        <div>
          <h3 className="text-2xl font-bold text-blue-700 mb-8 uppercase tracking-widest">Team Members</h3>
