...
const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Automates humidity, temperature, and light for mushroom farming.",
  },
  {
...
const ProductsPage = () => {
  ...
  return (
    <div className="w-full  bg-gradient-to-br from-blue-50 via-purple-50 to-white text-gray-800 relative overflow-x-hidden pb-16">
      ...
      {/* Hero Section */}
      <section className="w-full min-h-screen flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-r from-blue-100/70 to-purple-100/60 z-10 relative overflow-hidden">
        <motion.h1
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {PRODUCTS.map((product, i) => (
            ...
            >
              ...
              <h3 className="font-semibold text-lg mb-1 text-blue-700 group-hover:text-purple-700 transition-colors duration-200">
                {product.name}
              </h3>
              <span className="text-xs text-purple-500 font-medium mb-2">
                {product.tagline}
              </span>
          ...
          >
            ...
            <div className="flex flex-col gap-2 w-full">
              <span className="text-xs text-gray-400">
                For more info, contact us for a custom solution!
              </span>
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-2 px-6 rounded-full mt-2 hover:from-purple-600 hover:to-blue-600 transition-all">
                Contact Now
              </button>
            </div>
          </motion.div>
      ...
      <section className="w-full flex flex-col items-center justify-center py-12 px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-700 text-center mb-6 max-w-xl">
            We build tech tailored to your needs. Let’s create something amazing
            together.
          </p>
          <motion.button
      ...
      <style jsx global>{`
        ...
        @keyframes glow {
          0%,
          100% {
            box-shadow: 0 0 32px 0 #a21caf33;
          }
          50% {
            box-shadow: 0 0 64px 8px #a21caf55;
          }
        }
        .animate-float {
