...
const SERVICES = [
  {
    icon: <FaRobot className="text-4xl text-blue-500 mb-3" />,
  ...
  {
    icon: <FaCogs className="text-4xl text-purple-500 mb-3" />,
  ...
  {
    icon: <FaFlask className="text-4xl text-pink-500 mb-3" />,
    title: "R&D and Prototyping Support",
  ...
  {
    icon: <FaUserTie className="text-4xl text-blue-700 mb-3" />,
  ...
  {
    icon: <FaBoxOpen className="text-4xl text-orange-500 mb-3" />,
    title: "Electronic Kits & Learning Tools",
...
const TESTIMONIALS = [
  {
    quote:
      "Nepatronix's training transformed our students' interest in robotics!",
...
const ServicesPage = () => (
  <div className="w-full  bg-gradient-to-br from-blue-50 via-purple-50 to-white text-gray-800 relative overflow-x-hidden pb-16">
    {/* Section Title & Intro */}
    <section className="w-full min-h-screen flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-r from-blue-100/70 to-purple-100/60 z-10">
      <motion.h1
